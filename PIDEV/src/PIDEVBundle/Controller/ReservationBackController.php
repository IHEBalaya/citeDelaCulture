...
class ReservationBackController extends Controller
{
    public function affichageReservationAction()
    {
        ...
        $reservation=$this->getDoctrine()
            ...
            ->findAll();
        return $this->render('@PIDEV\ReservationBack\affichageReservationBack.html.twig', array(
    ...
    {$reservation=new Reservation();
        ...
        if ($form->isValid()) {
            ...
            if (isset($idE)) {
                ...
                if ($reservation->getDate() != $evenement->getDateebut())$e=1;
            ...
            $em->flush();
            if ($e==1) {
                return $this->render('@PIDEV\ReservationBack\erreurReservationBack.html.twig', array(
                    'form'=>$form->createView()));}
            return $this->redirectToRoute('affichageReservationBack');
        }
        return $this->render('@PIDEV\ReservationBack\ajoutReservationBack.html.twig', array(
            'form'=>$form->createView()
        ));
    }
    ...
    public function modificationReservationAction(Request $request,$id)
    {
        ...
        {$em->flush();
            return $this->redirectToRoute('affichageReservationBack');}
        return $this->render('@PIDEV\ReservationBack\modificationReservationBack.html.twig', array(
            'form'=>$form->createView()
        ));
